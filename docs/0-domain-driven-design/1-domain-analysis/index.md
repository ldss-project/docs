...
| Nome utente                                               | Username                      | Nome con con cui l'utente è riconoscibile all'interno del sistema.                                                                                                                                                                                                                                                                                                          | Meronimo di credenziali.                 |
...
| Giocatore guest                                           | Guest player                  | Giocatore che sta giocando a una partita che non è creata da lui.                                                                                                                                                                                                                                                                                                           | Iponimo di giocatore.                    |
| Giocatore host                                            | Host player                   | Giocatore che sta giocando a una partita che è creata da lui.                                                                                                                                                                                                                                                                                                               | Iponimo di giocatore.                    |
