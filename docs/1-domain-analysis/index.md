...
| Nome utente                                               | Username                      | Nome con con cui l'utente è riconoscibili all'interno del sistema.                                                                                                                                                                                                                                                                                                          | Meronimo di credenziali.              |
...
| Giocatore guest                                           | Player guest                  | Giocatore che sta giocando a una partita che non è creata da lui.                                                                                                                                                                                                                                                                                                           | Iponimo di giocatore.                 |
| Giocatore host                                            | Player host                   | Giocatore che sta giocando a una partita che è creata da lui.                                                                                                                                                                                                                                                                                                               | Iponimo di giocatore.                 |
| Identificatore di una partita                             | Game identifier               | Termine che identifica univocamente un partita nel sistema.                                                                                                                                                                                                                                                                                                                 | Meronimo di configurazione.           |
...
| Pedone                                                    | Pawn                          | Pezzo degli scacchi in grado di muoversi di una casella in avanti (oppure due nel caso della prima mossa) e di catturare pezzi avversari solo in diagonali.                                                                                                                                                                                                                 | Iponimo di pezzo.                     |
...
| Torre                                                     | Rook                          | Pezzo degli scacchi in grado di muoversi di un qualsiasi numero di casella in una delle direzioni cardinali.                                                                                                                                                                                                                                                                | Iponimo di pezzo.                     |
